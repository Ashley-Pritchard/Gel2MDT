...
user_response = input('Running this script will delete any empty_files.txt and Gel2MDT_Export_*_Mutation Report.csv files stored in this directory. Are you sure you want to continue? Please answer y or n: ')

if user_response == 'n':
	print('Please move files from this directory before running the script again.')
	sys.exit()
...
if os.path.exists(folder) == True:
	print('A directory already exists for this date, please move or rename this directory before running the script again.')
	sys.exit()
...
def make_folder(input_file_list):
	...
	#make directory refering to date of original proband_list file
